...
const DATA = {
  ...
  projects: [
    {project: "Hermoso - Sklep internetowy", role: "Front-End", description:[`Projekt sklepu internetowego z ubraniami dla kobiet. Zastosowanie rozbudowanej relacyjnej bazy danych.
    Wykorzystywane umiejętności: HTML5, CSS3, React with hooks, JavaScript, SQL, UX/UI design, współpraca z Django API, npm.`], dateStart: "2020-02", dateEnd:"do dziś"},
    {project: "Recruitment System", role: "Front-End, UX/UI Design", description:[`Projekt witryny internetowej rejestrującej aplikantów na stanowiska firmy klienta w wersji na przeglądarki mobilne. Zastosowanie rozbudowanej relacyjnej bazy danych.
    Wykorzystywane umiejętności: HTML5, SCSS, JavaScript, SQL, UX/UI design, współpraca z PHP, npm.`], dateStart: "2019-10", dateEnd:"2020-02"},
    ...
    Wykorzystywane umiejętności: HTML5, CSS, Photoshop, XML, obróbka i kompresja plików multimedialnych.`], dateStart: "2019-03", dateEnd:"2019-09"},
    {project: "jakiekieszonkowe.pl", role: "Front-End", description:[`Projekt witryny internetowej, która liczy średnie kieszonkowe grupując po szkołach, województwach, ilości dzieci. Została zaimplementowana relacyjna baza danych.
    Wykorzystywane umiejętności: HTML5, CSS, JavaScript, SQL, współpraca z PHP, npm.`], dateStart: "2019-03", dateEnd:"2019-09"},
  ],
  experience: [
    {employer: "KluboGaleria SARP,", address: "ul. Dyrekcyjna 9, 40-013 Katowice", position: "Kelner/Selekcjoner/Szatniarz", responsibilities: ["zapewnienie doskonałej i przyjaznej obsługi gościom","robienie podstawowych drinków/napojów, parzenie kawy, nalewanie piwa, bar-back","kulturalne selekcjonowanie gości na wejściu","zapewnienie porządnej i szybkiej obsługi na szatni"], dateStart: "2017-06", dateEnd:"do dziś"},
  ...
  education: [
    {school: "Politechnika Śląska,", faculty: "wydział AEiI, Gliwice", specjalization: "Teleinformatyka", dateStart: "2017-10", dateEnd:"do dziś"},
    {school: "Uniwersyteckie I Liceum Ogólnokształcące im. Juliusza Słowackiego w Chorzowie", faculty: "", specjalization: "matematyczno-informatyczno-fizyczna", dateStart: "2014-09", dateEnd:"2017-06"},
  ],
  skills: [
    {skill: "Programowanie JavaScript/React", progressBar: [5,"ES6+, React hooks"]},
    {skill: "Programowanie C/C++", progressBar: [5,"Programowanie obiektowe/strukturalne"]},
    {skill: "Front-end HTML5/CSS3", progressBar: [4,"Poziom średni"]},
    ...
    {skill: "Średnie doświadczenie w zarządzaniu social media (Facebook, Instagram, Youtube, Twitter)", progressBar: false},
    {skill: "NodeJS, Github, npm, TCP/IP, Scrum, Unix, SCSS/SASS", progressBar: false}
  ],
  languages: [
